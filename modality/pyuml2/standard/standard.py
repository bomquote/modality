...
import modality.pyuml2.standard_mixins as _user_module
...
@EMetaclass
class ImplementationClass(_user_module.ImplementationClassMixin, EObject):
    """
...
@EMetaclass
class Instantiate(_user_module.InstantiateMixin, EObject):
    """

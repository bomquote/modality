...
TemplateParameter.ownedParameteredElement.eOpposite = (
...
TemplateParameterSubstitution.templateBinding.eOpposite = (
...
InterfaceRealization.implementingClassifier.eOpposite = (

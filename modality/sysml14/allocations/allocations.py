...
from . import allocations_mixins as _user_module
...
class AllocateActivityPartition(
    _user_module.AllocateActivityPartitionMixin, EObject, metaclass=MetaEClass
):
    """
    AllocateActivityPartition is used to depict an «allocate» relationship on
    an Activity diagram. The AllocateActivityPartition is a standard
...
class Allocate(_user_module.AllocateMixin, DirectedRelationshipPropertyPath):
    ...
    relationship between the elements, their properties, operations,
